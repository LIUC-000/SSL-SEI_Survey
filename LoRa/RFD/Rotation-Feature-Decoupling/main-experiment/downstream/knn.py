...
def classify(k, SEED, ALL_acc, snr):
    ...
    online_network = get_pretrain_encoder(online_network, None,
                                          "../pretext/_experiments/Rot_Predict_CVCNN/feature_net_epoch300")
...
def clustering_FT():
    ...
    X_test, Y_test = TestDataset_prepared(range(20, 30))
