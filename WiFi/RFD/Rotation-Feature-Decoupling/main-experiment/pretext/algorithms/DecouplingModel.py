...
class DecouplingModel(Algorithm):
    ...
    def train_step(self, batch):
        ...
        with torch.set_grad_enabled(True):
            ...
            feature_rot, feature_invariance = torch.split(feature, 512, dim=1) # size 128，2048
        ...
        with torch.set_grad_enabled(False):
            ...
            feature_invariance_instance_mean = feature_invariance_instance_mean.view(4*len(feature_invariance_instance),512)
        #********************************************************
    ...
    def evaluation_step(self, batch):
        ...
        with torch.set_grad_enabled(False):
            feature = self.networks['feature'](dataX)
            feature_rot, feature_invariance = torch.split(feature, 512, dim=1)
