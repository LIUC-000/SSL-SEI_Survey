...
def get_config(config_root):
    ...
    parser.add_argument('--freeze', type=int, default=1, help='freeze the encoder (1: freeze, 0: not freeze)')
    ...
    parser.add_argument('--pretrain_encoder', type=str, default="feature_net_epoch300", help='the name of pretrain encoder')
